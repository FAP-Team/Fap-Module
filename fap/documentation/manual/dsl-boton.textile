...
Permite definir un botón, por defecto al pulsar el botón se llama al método del controlador del form que lo contenga. Dicho método recibirá tantos parámetros como botones se hayan declarado dentro del form, de manera que para saber que botón ha sido pulsado, debe comprobarse que el parámetro asociado a que botón no es null.  
