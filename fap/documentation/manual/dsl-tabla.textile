...
* **paginaVer = _[pagina]_** (opcional) : Asigna una pagina a la tabla, creando el botón Ver para abrirla. "Ver documentación Pagina":dsl-pagina.
* **paginaModificar = _[pagina]_** (opcional) : Asigna una pagina a la tabla, creando el botón Modificar para abrirla. "Ver documentación Pagina":dsl-pagina.
...
bc. Tabla:
	...
	(
		...
		& ('popupCrear' '=' popupCrear=[Popup|QN])?
	   	...
	   	& ('popupModificar' '=' popupModificar=[Popup|QN])?
	   	& ('popupVer' '=' popupVer=[Popup|QN])?
	   	& ('pagina' '=' pagina=[Pagina|QN])?
	   	& ('paginaCrear' '=' paginaCrear=[Pagina|QN])?
	   	& ('paginaBorrar' '=' paginaBorrar=[Pagina|QN])?
	   	& ('paginaModificar' '=' paginaModificar=[Pagina|QN])?
	   	& ('paginaVer' '=' paginaVer=[Pagina|QN])?
	)
	'{'
		columnas += Columna*
	'}'
...
h3. Tablas utilizando Pop-Ups (Todas las acciones (crear, ver, modificar y borrar) para el Pop-Up)
...
h3. Tablas utilizando Pop-Ups (Sólo permite Modificar y Ver las filas con Pop-Ups)
...
Pagina PaginaTablas campo=Solicitud {
	Tabla TablaConPaginas campo=TablaPaginas.tpaginas paginaCrear=CrearTablaPaginas paginaModificar=ModificarTablaPaginas paginaBorrar=BorrarTablaPaginas titulo="Tabla con paginas" columnasAutomaticas include=id{}
}