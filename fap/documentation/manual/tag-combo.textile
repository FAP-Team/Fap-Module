...
* **_anchoTitulo**  - Ancho de la etiqueta titulo
* **_mostrarClave(false)** - Indica si mostramos las claves del combo junto al valor (true), o sólo el valor (false)
* **_searchable** - Permite poner una caja de búsqueda en el combo para filtrar los items del mismo.
* **_multiple** - Permite indicar si el combo es de múltiple elección, es decir, poder seleccionar varios valores del mismo.
