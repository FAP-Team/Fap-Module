...
* **_[name]_**: Identificador del elemento. Sólo puede ser uno de los siguientes valores: crear, editar o borrar. El nombre que reciba el elemento determinará cual es las acciones es la que se va a configurar mediante este elemento.
