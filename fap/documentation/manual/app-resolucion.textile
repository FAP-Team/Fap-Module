...
En el caso de usar la ResolucionSimpleEjecucion o ResolucionMultipleEjecucion hay que cambiar los valores:

bc. ...
fap.resoluciones.generarDocumentoResolucion=false
fap.resoluciones.publicarTablonAnuncios=false
