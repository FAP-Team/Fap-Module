...
* Ruta para la subida de imágenes en el editor enriquecido para las plantillas (antiguos informes odt)
** Ejemplo: _fap.path.editor.img=/public/images_
* Ruta para la subida de ficheros temporales por el editor enriquecido para las plantillas (antiguos informes odt)
