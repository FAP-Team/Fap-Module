...
p. Para que la lista se pueda utilizar, por ejemplo en un combo, hay que actualizar la _Tabla de tablas_ en el panel de _Administración_, menú _Administración_, submenú _Tabla de tablas_ y botón "Actualizar Valores desde fichero (Sin Cargar Municipios)"  
