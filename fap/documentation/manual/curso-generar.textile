...
*  **--dev**: No añade en el classpath las librerías compiladas y añade las rutas @$FAPSDK/compiler-src/es.fap.simpleled.generator/bin@ y @$FAPSDK/compiler-src/es.fap.simpleled/bin@ de manera que permite trabajar directamente con el generador compilado con Eclipse, sin tener que exportar el jar.
