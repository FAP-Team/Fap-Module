...
Las plantillas se definen utilizando HTML, CSS y los tags de play.
Puedes consultar la lista de tags disponibles en "http://www.playframework.org/documentation/1.2.2/templates":http://www.playframework.org/documentation/1.2.2/templates y en "http://www.playframework.org/documentation/1.2.2/tags":http://www.playframework.org/documentation/1.2.2/tags
