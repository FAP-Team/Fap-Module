...
* **minimo= _[string]** (opcional): Valor mínimo que tendrá la barra deslizante. Si no se especifica será 0.
* **maximo= _[string]** (opcional): Valor máximo que tendrá la barra deslizante. Si no se especifica será 100.
* **valorDefecto= _[string]** (opcional): Valor por defecto donde se situará la barra deslizante entre el mínimo y el máximo. Si no se especifica será el valor mínimo indicado.
...
bc. BarraDeslizante:
	elemento='BarraDeslizante' (name=ID)? (
		...
		& ('ancho' '=' ancho=STRING)?
		& ('minimo' '=' minimo=STRING)?
		& ('maximo' '=' maximo=STRING)?
		& ('valorDefecto' '=' valorDefecto=STRING)?
