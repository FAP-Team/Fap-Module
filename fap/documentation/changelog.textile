...
h3. Version 2.0 (En desarrollo)

* En esta versión se introducen pequeños cambios relacionados con la forma de escribir el DSL. Para adaptar a la versión 2.0, los ficheros DSL escritos con versiones previas, véase la siguiente página de documentación: "Adaptación de los ficheros DSL a la versión 2.0":version2.0DSL.
