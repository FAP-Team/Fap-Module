...
* **metodoFilas = _[string]_** (opcional): Al emplear este parámetro se ejecutará el controlar indicado que devolverá la lista de elementos que se mostrarán en la tabla.
