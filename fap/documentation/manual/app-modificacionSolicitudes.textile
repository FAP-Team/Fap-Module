...
* La segunda parte de la página es un combo que permite restaurar los datos modificados al estado anterior, es decir, al estado como estaban la última vez que se hizo una presentación. Esto es util para casos en que el solicitante haya pedido modificar pero se arrepienta y no quiera modificar nada, o el propio gestor/administrador se hayan equivocado y no procediera la modificación. Es una salvaguarda por motivos de seguridad e integridad de los datos tan delicados que se manejan.
