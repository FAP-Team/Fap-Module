...
h3. Versión 2.1.1RC11

* Fixed Bug en Recuperar Info Certificado para Agente y Firma.
* No permitiendo a los Evaluadores recargar los Conceptos Economicos.
* No se muestran los "firmantes" en Aportación (No eran los firmantes correctos).
* Verificando sólo los trámites que se asignen como verificables.
* Fixed Bug en ConsultarEvaluaciones.
* Fixed Minor Bugs.

h3. Versión 2.1.1RC10

* Copia extra de logs mediante property "fap.log.copy.extra".
* Guardado obligatorio de PCEconomicos antes de presentar dependiendo de si hay TiposCEconomicos.
...
* Fixed Bug en Conceptos Economicos de tipo Otros del Solicitante.
...
* Fixed bugs en Aceptación/Renuncia.
* Fixed bug extensiones ahora no tiene en cuenta las mayúsculas o minúsculas para diferenciar.

h3. Versión 2.1.1RC4

* Fixed bug Redirección en preparar Aceptación o Renuncia.
* Fixed bug Acceso a nuevas verificaciones.
* Fixed Minor Bugs.
...
* En Evaluación se muestran los "automod" como los "auto".

h3. Versión 2.1.1RC2

* Fixed Bug en autoenviar en los Forms.
* Añadiendo Permisos a toda la parte de Baremación.
* Nuevo atributo noVisibleEvaluador en Criterios.
* Calculo de los criterios dependiendo de su valor máximo.
* Recalculados los criterios dependiendo del rol de quien los vea.
* Botón reevaluar en la tabla de evaluaciones.
* Footer de la Solicitud a Evaluar.
* Fixed Minor Bug en Baremación.

h3. Versión 2.1.1RC1

* Mejorada y Optimizada la Carga de la Tabla de Tablas.
* Fixed Bug en Baremación.
* Nuevos rol de Evaluador.
