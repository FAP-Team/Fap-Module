...
* **valor = _[ID]_** : Identificador del elemento RadioButton que queremos que sea el valor por defecto. Si asignamos este parámetro, todos los RadioButtons contenidos en este grupo deberán tener un identificador.
...
Cuando el atributo es de tipo lista, se creará automáticamente tantos selectores de tipo radio como elementos definidos en la lista.
...
h3. Uso del parámetro @valor@

bc.. 			
GrupoRadioButtons titulo="Parentesco del familiar" valor=hijos campo=Solicitud.familia.parentesco {
	RadioButton padres valor="Padre/Madre"
	RadioButton hermanos valor="Hermano/Hermana"
	RadioButton hijos valor="Hijo/Hija"
}

h4. Resultado:

!images/dsl-grupoRadiosParamValor!
