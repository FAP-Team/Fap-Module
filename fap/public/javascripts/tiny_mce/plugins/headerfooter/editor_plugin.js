...
(function() {
	...
	tinymce.create('tinymce.plugins.HeaderFooterPlugin', {
		init : function(ed, url) {
			...
			// Register commands
			ed.addCommand('mceHeaderFooter', function(ui) {
			...
			ed.addCommand('mceInsertHeaderFooter', t._insertTemplate, t);

			// Register buttons
			ed.addButton('headerfooter', {
			    title : 'Insertar cabecera y pie', 
			    cmd : 'mceHeaderFooter',
			    image : url + '/img/guardarheaderfooter_editor_icono.png'
			});
...
*/
	...
	// Register plugin
	tinymce.PluginManager.add('headerfooter', tinymce.plugins.HeaderFooterPlugin);
})();
