...
* **redirigir = _[pagina]_** (opcional) : Cuando termina la acción del botón del form, se produce una redirección a la página especificada.
* **destino = _[string]_** (opcional) : Indica al enlace donde tiene que abrirse, si quiere abrirse en una página distinta (campo target en html).
