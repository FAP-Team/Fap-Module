...
bc. public boolean check(String id, String _permiso, String action, Map<String, Long> ids, Map<String, Object> vars);
...
* **_permiso** - permiso del elemento gráfico que se está consultando (editable, visible, none).
* **action** - Acción del permiso que se está consultando (leer, editar, crear, borrar).
