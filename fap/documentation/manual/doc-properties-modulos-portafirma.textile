...
| Personalizacion de mensajes de Error | *fap.portafirma. secret.key* | _String_ | fap.portafirma. secret.key=undefined |
| Nombre de usuario | *portafirma.usuario* | _String_ | portafirma.usuario= PRESTAMOS |
| Portafirma | *portafirma. webservice.wsdlURL* | _String_ | portafirma.webservice. wsdlURL=undefined |
| Servicio portafirmas | *fap.platino.portafirma. url* | _String_ | fap.platino. portafirma.url= http://buger.gobiernodecanarias. net: 8077/ portafirmas/solicitudfirma/ |
