...
9. Genera la aplicación. Este paso lo tendras que repetir cada vez que modifiques algún fichero .fap. Puedes generar la aplicación mientras está arrancada. Actualiza la página en el navegador para ver los cambios reflejados. 
