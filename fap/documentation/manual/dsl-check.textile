...
* **titulo = _[string]_** : Etiqueta que se mostrará al lado del check, si no se especifica se mostrará el nombre del campo.
...
* **ayuda = _[string]_** (opcional) : Ayuda asociada al check box.
