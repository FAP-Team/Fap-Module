...
* **_[name]_**: Identificador del elemento. Solo puede ser uno de los siguientes valores: crear, editar o borrar. El nombre que reciba el elemento determinará cual es las acciones es la que se va a configurar mediante este elemento.
...
* **crearSiempre** (opcional): Indica que crearemos por defecto en el controlador los métodos correspondientes a la acción que se está configurando, aún cuando dicha accion no se utilice nunca en el ámbito del DSL. 
