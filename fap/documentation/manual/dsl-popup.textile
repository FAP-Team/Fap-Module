...
* **entidad = _[entidad]_** : Define la entidad que se puede usar en los campos que se sitúen dentro del popup.
...
bc. Popup PopupUsuario entidad=Agente titulo="Usuario" {
