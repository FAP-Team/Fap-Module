...
* **firmantes = _[campo]_** : Campo donde se encuentra la lista de personas que tienen que firmar el documento. Tiene que ser un OneToMany de Firmante.
* **registroFirma = _[campo]_** : 
* **calcularFirmantes = _[campo]_** : Campo donde se almacenará la cantidad de firmantes que han firmado.
* **setToTrue = _[campo]_** : Una vez que se firma bien, setea el campo especificado a true.
