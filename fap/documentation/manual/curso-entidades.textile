...
Las entidades se definen en el fichero entidades.play de nuestra aplicación, todas las entidades deben tener un *nombre* y al menos un *atributo*. La definición completa de una entidad se puede ver en "entidad":dsl-entity.
...
Al asignar el tipo *extends Singleton* solo se creara una instancia de la clase generada por esta entidad.
