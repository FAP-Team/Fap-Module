...
Suponiendo que se desean realizar comprobaciones de requisitos adicionales a la baremación, o comprobaciones que solo puedan ser realizadas una vez se rellene por completo el formulario de la baremación, se puede sobreescribir el método _checkFinalizarEvaluacion_. Por defecto, el método devuelve _true_.
