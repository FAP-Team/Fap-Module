...
public class PopUpDocAportadosControllerGen extends GenericController {
    ...
    protected static Documento getDocumento(Long idSolicitud, Long idDocumento){
        ...
        if(idSolicitud == null){
            ...
            documento = Documento.find("select documento from SolicitudGenerica solicitud join solicitud.documentacionProceso.documentos documento where solicitud.id=? and documento.id=?", idSolicitud, idDocumento).first();
            if(documento == null){
	...
	public static void abrir(String accion,Long idDocumento,Long idSolicitud){
		...
		renderArgs.put("controllerName", "PopUpDocAportadosControllerGen");
		renderTemplate("gen/popups/PopUpDocAportados.html",accion,idDocumento,documento,idSolicitud);
			...
			@Util
			protected static void PopUpDocAportadosValidateCopy(Documento dbDocumento, Documento documento){
