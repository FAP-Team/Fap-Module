...
Este método quizás es el que menos se debería personalizar, porque su comportamiento ya es lo suficientemente genérico como para personalizarlo en sí mismo. Si se quiere realizar algo en concreto, seguro que se podrá conseguir sobreescribiendo los otros métodos dejando este intacto.Si aún así se considera oportuno sobreescribir este método, asegúrese de saber bien lo que está haciendo en cada momento, porque este es el método que se llamará en el evento del botón como se comentó antes.
