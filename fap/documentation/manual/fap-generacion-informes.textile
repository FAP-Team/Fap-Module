...
Para la generación de los informes de play se utiliza el modulo PDF cuya documentación se puede esncontrar sifuiendo este enlace "Click aquí":http://www.playframework.org/modules/pdf. 
No obstante, también está disponible la clase **reports.Report** del módulo, la cual contiene algunos métodos de ayuda para crear los informes.
...
Lo ideal sería mantener la misma jerarquía en la aplicación que en FAP. Por tanto, las plantillas que se crean, deberían guardarse en app/views/reports.
...
Las plantillas se definen utilizando HTML, CSS y los tags de play. Puedes consultar la lista de tags disponibles en los siguientes enlaces: "Templates":http://www.playframework.org/documentation/1.2.2/templates y "Tags":http://www.playframework.org/documentation/1.2.2/tags

h3. Ejemplo de plantilla

Como se comentó antes, en la plantilla sólo se tendrá acceso a aquellas variables que se le pasó por parámetro. En este caso sólo se podrá acceder a toda la información que dispone la "solicitud" que se le pasa.
...
Si requiere algún tipo de documentación sobre CSS recomendamos encarecidamente la siguiente web: "Paged Media w3c":http://www.w3.org/TR/CSS21/page.html
