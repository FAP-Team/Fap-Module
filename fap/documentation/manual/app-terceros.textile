...
bc. public List<Solicitante> buscarTercerosDetalladosByNumeroIdentificacion(String numeroIdentificacion, String tipoIdentificacion) throws TercerosServiceException;

Que a través de un Numero de Identificación y su Tipo (Por ejemplo: 11111111H y "NIF") devuelve la lista de Solicitantes que tenga la BDD a Terceros consultada y que concuerde con esos dos datos.
