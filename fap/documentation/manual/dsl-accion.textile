...
* **noBorrarEntidad** (opcional): Si se especifica, en la acción de borrar no se borra la entidad seleccionada, sino sólo se desenlaza de la lista en la que estaba. Por ejemplo, si la entidad está en un OneToMany, la quita del OneToMany, pero no la elimina de base de datos.
