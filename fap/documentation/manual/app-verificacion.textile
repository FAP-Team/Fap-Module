...
_NOTA: Para llamar a los métodos que sobreescribamos deberemos llamarlos de la siguiente forma (si queremos llamar al getDocumentosCondicionadosAutomaticos, por ejemplo):_

**VerificacionFapController.invoke("getDocumentosCondicionadosAutomaticos", tramite.nombre, idSolicitud);**
...
bc. public static List<String> getDocumentosCondicionadosAutomaticos (String uriTramite, Long idSolicitud){
   ...
}
