...
Cada trámite está activo en una o varias fases del procedimiento administrativo (Solicitud, Instrucción, Resolución y Ejecución). Los trámites estándares son:
...
En el caso de que se quiera personalizar algunos métodos concretos de un trámite, hay que tener en cuenta que el nuevo trámite tiene que extender de algunos de los trámites existentes en FAP.

bc.  TramiteNuevo -->  TramiteBase/TramiteAlegacion/TramiteDesistimiento/TramiteAceptacionRenuncia

Simplemente hay que crear una clase en el paquete _tramitación_ de la aplicación:

bc. public class TramiteNuevo extends TramiteBase {
...
}

Una vez se escriba esto, podrás sobreescribir los métodos que quieras del trámite.
