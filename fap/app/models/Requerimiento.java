...
public class Requerimiento extends Model {
	...
	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaRegistroSalida"),
			@Column(name = "fechaRegistroSalidaTZ") })
	...
	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaAcuse"), @Column(name = "fechaAcuseTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	...
	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaAcceso"), @Column(name = "fechaAccesoTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	public DateTime fechaAcceso;

	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaNotificacion"),
			@Column(name = "fechaNotificacionTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	public DateTime fechaNotificacion;

	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaVencimiento"),
			@Column(name = "fechaVencimientoTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	...
	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaDisposicionSede"),
			@Column(name = "fechaDisposicionSedeTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	public DateTime fechaDisposicionSede;

	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaAcuseSede"),
			@Column(name = "fechaAcuseSedeTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	public DateTime fechaAcuseSede;

	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaRechazoSede"),
			@Column(name = "fechaRechazoSedeTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	...
	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaEnvioPostal"),
			@Column(name = "fechaEnvioPostalTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
	public DateTime fechaEnvioPostal;

	@org.hibernate.annotations.Columns(columns = {
			@Column(name = "fechaAcusePostal"),
			@Column(name = "fechaAcusePostalTZ") })
	@org.hibernate.annotations.Type(type = "org.jadira.usertype.dateandtime.joda.PersistentDateTimeWithZone")
