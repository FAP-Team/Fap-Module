...
h3. Versión 1.3.5 RC5

* Disponibles nuevos estados de Solicitud.
...
* Añadido botón de finalizar Exclusión.
* Fixed Bug en el PDF del borrador del Requerimiento en Verificación.
* Fixed Bug en funcion a sobreescribir para conocer los documentos condicionados automaticos en Verificación.
* Fixed Minor Bug en Verificación de Tipos.
* Fixed Bug Upload JavaScript.

h3. Versión 1.3.5 RC4

* Fixed Bug en la fecha de registro de los documentos presentados no pertenecientes al trámite de la Verificacion.
* Requerido el trámite para iniciar la Verificación.

h3. Versión 1.3.5 RC3

* Fixed Bug en el PDF del borrador del requerimiento, quitando atributos que no hacían falta.
* Fixed Bug en método trim() de JavaScript en PopUps Manuales de Exclusión y Requerimiento.

h3. Versión 1.3.5 RC2

* Fixed Bug al utilizar la Release Candidate.
* Añadida la exclusión de la solicitud.
* Fixed Bug en la clase que hay que sobreescribir VerificacionFAPController, para indicar los documentos concretos a verificar.
* Fixed Bug al visualizar el detalle de un documento en la verificación de tipos.
* Fixed Bug al descargar recibo de la solicitud en Verificación.
* Ampliado el ancho de los elementos html del popup de verificación de un documento.
* Combo de selección de un requerimiento por descripción corta.
* Fixed Bug Botón Obtener Borrador Requerimiento en Verificación.
* Fixed Bug PDF Borrador Requerimiento en Verificación.

h3. Versión 1.3.5 RC1
