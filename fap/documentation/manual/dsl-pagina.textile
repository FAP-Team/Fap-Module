...
* **campo = _[campo]_** (opcional) : Define la entidad que se puede usar en los campos que se sitúen dentro de la página. Si no se especifica este parámetro, tendrá que ser especificado en el formulario que contiene a esta página.
...
bc. Pagina Solicitudes noForm campo=Solicitud{
	....
	Form nuevaSolicitud {
...
h3. Pagina sin especificar campo

_*¡Ojo!:* al no especificar el 'campo', se debe especificar en el Formulario que contiene a esta pagina, indicando que *todas* las paginas de ese formulario utilizan la Entidad especificada en dicho Formulario_
