...
* En la tabla _Tabla de Peticiones de Cesiones_, pulsar en el botón *Nuevo* y en la nueva página que aparece, seleccionar en el combo _Tipo de Cesion_, el tipo de la cesión que quiere realizarse, en cuanto se pulse guardar, la petición pasa al estado _creada_.
* Una vez elegido el tipo de cesión se mostrará una tabla con todas las solicitudes que han autorizado dicho tipo de cesión, de manera que podemos elegir los expedientes a consultar. Una vez seleccionados se pulsará _Generar Petición_ que generará el fichero de opetición de cesión de datos y nos devolverá a la pagina de Cesión de Datos.
...
* Una vez aplicados los cambios, la petición de cesion de datos pasará al estado _asignada_, de manera que no se podrán realizar modificaciones.
