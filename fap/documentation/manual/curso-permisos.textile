...
En este ejemplo, se indica que cuando solicitud.mientidad.campo1 sea true, permitirá realizar cualquier accion de crear, editar, leer o borrar sobre los elementos en los que actúa el permiso y, que todos los elemetos gráficos web sean editables y visibles.
