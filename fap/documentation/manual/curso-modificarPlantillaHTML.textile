...
Existe una página "404.html", que es la que se muestra en las aplicaciones FAP por defecto ante dicho error. Sobreescribiendo esta página en nuestro proyecto, cambiaríamos este comportamiento y cuando ocurriese el error 404 se mostraría nuestra nueva página de error.
