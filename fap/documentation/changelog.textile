...
* Añadidos codigos de exclusión a la Verificación.
...
* Ampliado el ancho de lod elementos html del popup de verificación de un documento.
* Combo de selección de un requerimiento, ahora está por la descripción corta.
* Fixed Bug Botón Obtener Borrador Requerimiento en Verificacion.
