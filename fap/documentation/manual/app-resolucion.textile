...
Se pueden personalizar los distintos tipos de resolución sobreescribiendo una serie de métodos que se encuentran en la Resolución Base.
...
* getFooterReport(): Debe devolver la plantilla HTML del pie de página del documento borrador de la Resolución. Se debe conocer que la ruta es relativa a partir de app/views.
