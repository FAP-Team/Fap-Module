...
Supone que el país será España. A partir de ahí deja seleccionar la comunidad autonoma que queramos, y dependiendo de esta, su provincia. Dependiendo de esta provincia podremos seleccionar un municipio.

Otros valores que se pueden rellenar son: localidad, codigo postal, calle, numero, otros (puerta,etc.).

h3. Dirección Internacional

Permite seleccionar un País, de la lista de todos los paises del mundo.
