...
* Fixed Bug en el install de generado por fap:winservice.
* Fixed bug en Baremación.
* Fixed bug Desistimiento.
* Fixed Bug en Funcionario Habilitado.
* Inhabilitando el evento Enter como envio de Form en los PopUp.
* Botón Anular en Verificación.
* Fixed Bug en los Tipos de Botones que se pueden usar.
* Fixed bug enlace.html (en la llamada al popup).
* Fixed Bug en Tramitación.
* Mejora en la Documentación.
* Añadiendo a cada página de FAP a que módulo pertenece.
* Eliminando las dependencias de las properties del modulo en las rutas.

h3. Versión 2.1RC13

* Fixed Bug al crear expedientes que ya existían.
* Ficed Bug en Desestimiento.
* Fixed Bug en Baremación.
* Fixed Bug en Permisos.

h3. Versión 2.1RC12

* Desistimiento correcto.
* Se puede configurar el timeout de los servicios.
* Fixed bug registro de solicitantes con pasaporte.
* Servicio de notificaciones (según property).
* Rutas que se activan o no según properties.
* Nombre de usuario se cambia cuando entra por primera vez con el certificado.
* PCEconómicos tiene un guardar para preparar.
* Añadidos certificados en el firma-fs.
* Fixed bug conceptos manuales.
* Fixed bug conceptos otros.
* Fixed bug info certificado.
* Fixed bug firmas en el Aed.
* Reenumerados los pasos en Firma y Registro.
* Mostrando info del "padre" en los conceptos económicos.
* Se permite borrar en las tablas de Documentos y Conceptos Económicos.
* Fixed bugs. 

h3. Versión 2.1RC11

* Hack para firmar y registrar con A9999999 y ESA9999999.
* Envío del correo de registro después de realizar todos los pasos.
* Fixed Bug en Consultas BBDD desde Administración.
* Añadidas 3 consultas por defecto a la BBDD desde Administración.
* Fixed bug ayuda con iconos.
* getFirmantes no crea uno nuevo.
* Fixed bug presentación.
* Fixed bug búsqueda de firmantes.
* Fixed bug posición BigPopup.
* Permitir no informar del servicio de notificaciones.
* Property para mostrar o no los iconos en los input.
* Logs de PlatinoFirmaService ok.
* Fixed permisos.

h3. Versión 2.1RC10

* Fixed Bug en Verificación.
* Fixed Bug en Conceptos Economicos.
* Fixed Bug en BuscarLogs sobre distribuciones FAP (dist).

h3. Versión 2.1RC9

* Fixed Bug en Verificación.
* Fixed Bug en Presentación de Persona Jurídica.
* Añadida columna totales por Concepto Económico.

h3. Versión 2.1RC8

* Fixed Some Bug en Verificación.
* Fixed Bug en retrocompatibilidad con el elemento Dirección anterior a la versión 2.1.
* Fixed Minor Bug en template.html.
* Minor Fixed Bug.

h3. Versión 2.1RC7

* Fixed bugs en Verificaciones posteriores.
* Fixed bugs en combos no Editables tras error de validación.
* Mensaje de error en los elementos de tipo moneda se obtiene de "fap.mensaje.error.moneda".
* Escala de job de anotaciones ahora en horas.
* Informe de seguimiento en nueva pestaña.
* Añadidos iconos en la pantalla de login.
* Añadido icono de Euro a los tipo Moneda.
* Fixed bugs en Presentación, PersonaFisica,...
* Fixed some minimal bugs.

h3. Versión 2.1RC6

* Fixed Bug en el cálculo de los conceptos económicos.
* Nuevo elemento CCC, para representar una Cuenta Corriente Cliente.
* Fixed Bug en ConfigurarMensajes.
* Redefiniendo las columnas de la tablas DocumentacionFAP.
* Fixed Bug en Documentación Externa.
* No se envían ahora los campos ocultos por grupos.
* Minor Fixed Bug.

h3. Versión 2.1RC5

* Mejorada la página de conceptos económicos.
* En los conceptos económicos ahora son de tipo Moneda.
* Añadida la cadena "RE" cuando se registra en Platino.
* Fixed bug baremación.
* Fixed bug al mostrar solicitudes sin estado.
* Añadido el método formatMoneda() que es que se utilizará para los elementos tipo Moneda.
...
* Alineado de los elementos en las columnas de las tablas (tipo moneda alineado por defecto a la derecha).
* Se permite especificar un número mínimo y máximo de decimales en los atributos de tipo moneda y en los double.
* Fixed Bug redireción después de los PopUp.
* Fixed Bug en cambiar password de los usuarios.
* Fixed Bug en validar las páginas antes de abrir una página de tabla.
* Fixed Minor Bugs.

h3. Versión 2.1RC3

* Validando y guardando datos en paginas que tienen tablas que van a otras paginas. 
* Fixed Bug en Monedas y Doubles.
* Fixed Bug al tener paginas o popups solo con crear o con un editar distinto en tablas.
* No permitir al usuario que entra por certificado gestionar contraseñas.
* Fixed Bug en el enlace al requerimiento en verificaciones anteriores.
* Permitiendo algunas retrocompatibilidades con versiones anteriores a la versión 2.1.
* Fixed Minor Bugs.

h3. Versión 2.1RC2

* Seguimiento incluido en el módulo de FAP.
* Pagina en Administración que permite configurar mensajes en cualquier página definida en el DSL.
* Fixed Bug en la carga del fichero .json de Baremación en modo Servicio de Windows.
* Permitir habilitar/deshabilitar y configurar los Jobs del módulo FAP en el panel de Administración.
* Nuevo elemento barraDeslizante.
* Nuevo elemento RadioBooleano.
* MostrarSiRadioBooleano en Grupos.
* Personalizando algunos elementos con iconos.
* DatePicker usando Bootstrap.
* Cambiado los BigDecimal a Doubles, por problemas varios con los BigDecimal.
* Añadido método para mostrar información de la inyección de dependencias al iniciarse las aplicaciones.
* Añadidos titulos a todas las páginas del módulo FAP.
* Rediseño de la página de Subir Documentación del módulo FAP.
* No se muestran los logs de auditoría en la página Logs de Administración.
* Elemento Ayuda en el elemento Grupo.
* Fixed Bug en Tooltip de tablas.
* Fixed Minor Bugs.

h3. Versión 2.1RC1

* Páginas por defecto en FAP para la Presentación.
* Nueva tabla de Documentación Externa en la Documentación FAP y en Aportación.
* Nuevo elemento DireccionMapa, utilizando la API de Google Place.
* Mejoras en los otros elementos Direcciones.
* Fixed Bug al utilizar código Groovy en los Wikis del DSL.
* Mejoras en el campo Moneda y su representación en tablas.
* Fixed Bug en el formato de los doubles en tablas.
* Página de Autorizaciones.
* Visbles todas las notificaciones por los roles admin y gestor.
* Nuevas funciones de interesados y representantes en SolicitudGenerica.
* Nuevas funciones para consultar los atributos de Documento.
* Mayor nivel de contenido en la documentación.
* Mensaje de recomendación de IE9 cuando se usa IE8.
* Fixed Bug en los wikis o mensajes de la páginas FAP.
* Fixed Minors Bugs.
