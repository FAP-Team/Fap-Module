...
Dentro de las Entidades, se definen los diferentes atributos que queremos representar y que nos servirá para almacenar todo tipo de información en nuestro Modelo. Para ver más detallado todos los aspectos de los atributos que podemos declarar dentro de nuestrar Entidades FAP, visita la sección "Atributos de las Entidades":atributos-entidades
