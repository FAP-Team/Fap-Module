...
** **mostrarTablaSeleccionados** (opcional) : Solo posible si la tabla es _seleccionable_. Se muestra debajo de la tabla principal una nueva tabla con la selección realizada.
...
* **permisoFilas = _[permiso]_** (opcional) : Permite asignar permisos a la tabla, estos permisos se utilizarán para filtrar las filas que se muestran en la tabla.
...
h3. Columnas automáticas utilizando exclude
