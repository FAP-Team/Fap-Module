...
public class FichaEvaluadorController extends Controller {
	...
	public static void index(long idEvaluacion){
		...
		if(evaluacion.tipo == null){
			TipoEvaluacion tipo = TipoEvaluacion.all().first();
	...
	private static void initEvaluacionTecnologos(Evaluacion evaluacion) {
	...
	private static void initEvaluacionInnovacion(Evaluacion evaluacion) {		
		TipoCriterio t1 = new TipoCriterio();
		t1.nombre = "Componente inovadora y tecnológica predominante";
		t1.claseCriterio = "auto";
		t1.jerarquia = "A";
		t1.tipoValor = "cantidad";
		t1.descripcion = "";
		...
		TipoCriterio t1_1 = new TipoCriterio();
		t1_1.nombre = "Carácter de la empresa de base tecnológica";
		t1_1.claseCriterio = "manual";
		t1_1.jerarquia = "A.1";
		t1_1.tipoValor = "lista";
		addLValores(t1_1, 7D, "ALTO: Fecha constitución EBT ≤ 2 años");
		addLValores(t1_1, 5D, "MEDIO: Fecha constitución EBT > 2 años y ≤ 6 años");
		addLValores(t1_1, 0D, "BAJO: Fecha constitución EBT > 6 años");
		t1_1.descripcion = "Prioridad a empresas de nueva o reciente creación frente a las ya consolidadas";
		t1_1.comentariosAdministracion = true;
		t1_1.comentariosSolicitante = true;
