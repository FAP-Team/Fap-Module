...
h2. Configuración Context Path, para subsanar el problema de cambio de rutas al redireccionar

Para ello en el fichero **application.conf** tenemos una propiedad que se llama **fap.ctxPath** y que está comentada. La descomentamos y ponemos la ruta donde estará nuestra aplicacion, es decir:
