...
h3. Versión 1.3.11RC4

* Fixed bug extraer informacion del certificado (Issue 305).

h3. Versión 1.3.11RC3

* Actualizadas librerias aed, procedimientos, gestorDocumental.
* Fixed bug extraer informacion del certificado (Issue 305).
* Javascripts actualizados para que funcione la configuración de platino.
* Fixed bug ubicación wsdl en AedClient y TiposDocumentosClient.

h3. Versión 1.3.10

* Timeout en los servicios mediante la property "fap.servicios.httpTimeout".
* Fixed bug en copia del campo descripción en Documento. 

h3. Versión 1.3.9

* Tipo de documentos Otros, reemplazado por la multiplicidad del tipo de documento.
* Tipo y descripción visible en todas las tablas de documentos en las páginas por defecto de FAP.
* Fixed bug en email del representante de un solicitante.
* Descripción de los documentos como Área de Texto.
* Fixed bug en Validación.
* Añadida fecha de Registro en las tablas de documentación de Aportación de FAP.
