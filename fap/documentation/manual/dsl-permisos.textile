...
Para la definición de permisos se tendrá una serie de variables especiales.
*  **agente** : Agente conectado actualmente. Puede ser null.
*  **_accion** : Acción para la que se está consultando el permiso (leer, editar, crear, borrar).
