...
Vemos que el m�dulo FAP tiene 2 implementaciones del servicio, y nuestra aplicaci�n puede a su vez tener todas las implementaciones que queramos y usaremos la que configuremos en el _AppModule.java_.