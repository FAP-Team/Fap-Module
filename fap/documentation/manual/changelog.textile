...
* Se permite recalcular las evaluaciones a los administradores.

h3. Versión 2.1.2RC7

* Máscara "Cargando..." en las tablas.
* Verificación: Fixed some bugs.
...
* Verificación: Fixed bug permiso.
...
* Fixed buf duplicar documento AED.
