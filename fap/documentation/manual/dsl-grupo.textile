...
* **mostrarSiRadioBooleano _[radioBooleano]_ = true | false** (opcional) : Muestra el grupo si el valor del radioBooleano específicado es "true" o "false". False significa que está activo el botón izquierdo, y true que es el botón de la derecha el que está presionado.
