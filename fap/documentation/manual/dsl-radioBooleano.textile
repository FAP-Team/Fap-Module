...
* **botonIzquierdo= _[string]_** (opcional): Indica el nombre que va a poseer el botón de la izquierda del radio booleano.
* **botonDerecho= _[string]_** (opcional): Indica el nombre que va a poseer el botón de la derecha del radio booleano.
