...
public class AedServiceTest extends UnitTest {
	...
	public void saveDocumentoTemporal() throws Exception {
		...
		PropiedadesDocumento propiedades = aedService.obtenerPropiedades(uri,
				false);
	...
	public void crearCarpetaTemporalDebeFallarSiCarpetaNull() throws Exception {
		aedService.crearCarpetaTemporal(null);
	}
	...
	public void crearCarpetaTemporal() throws Exception {
		...
		aedService.borrarCarpetaTemporal(firstPath);

		Assert.assertFalse(aedService.existeCarpetaTemporal(path));
		aedService.crearCarpetaTemporal(path);
		Assert.assertTrue(aedService.existeCarpetaTemporal(path));
