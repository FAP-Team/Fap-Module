...
h2. "Anotaciones Administrativas Autorizadas":app-aaa

Añade una página a las aplicaciones que permite al solicitante pedir ciertos tipos de certificados que se generan sobre la marcha. El Gestor podrá definir a través del panel de Administración los tipos de Certificados de la aplicación rellenando una serie de parámetros. El solicitante, podrá pedir tantos certificados como requiera, simplemente seleccionando su tipo en un combo que listará todos los tipos que haya definido el gestor en el panel de Administración.
...
Funcionalidad que suelen necesitar bastantes aplicaciones telemáticas de administración eletrónica. Su cometido es el de poder evaluar las solicitudes siguiendo el baremo que se haya estipulado en la convocatoria pertinente, para así poder calcular qué solicitudes son supceptibles de percibir lo que piden. Se usa mucho en convocatorias de procedimientos competitivos.

h2. "Desistimiento":app-tramitacion

Esta funcionalidad también está orientada al solicitante. Permite que éste desista la solicitud, una vez la haya presentado correctamente, en cualquier momento. De forma que la administración no la va a seguir teniendo en cuenta en sucesivas fases del proceso administrativo. Obviamente el desestimiento tiene una vida de uso, que va desde que se presenta la solicitud hasta justo antes de resolverse la convocatoria en cuestión, ese es el tiempo que tiene el solicitante para desistir su solicitud si así lo ve conveniente.
...
Existe la posibilidad de que por diversos motivos un solicitante no pueda firmar ni registrar la solicitud, ya sea por un problema con su navegador o cualquier otra causa. En estos casos, existe la posibilidad de utilizar una funcionalidad que trae FAP implementada y que permite que un usuario delegue estas acciones en un Funcionario Público (denominado Habilitado).

h2. "Login":app-login

Este módulo es el que permite loguearte a la aplicación. FAP por defecto permite el login de dos tipos: con certificado digital y con usuario y contraseña, permitiendo usar estos métodos de forma totalmente independiente, usar uno sólo o ambos. También FAP está preparado para que mediante la sobreescritura de unos métodos concretos, podamos implementar otro tipos de autenticaciones, como pueden ser por ejemplo con OpenID o incluso con las cuentas de las Redes Sociales.

h2. "Modificación de Solicitudes":app-modificacionSolicitudes

El proceso de Modificación de Solicitudes es el que permite modificar un dato concreto en las solicitudes una vez se haya presentado ésta. Este es un proceso complicado porque se modificará un dato que ha sido firmado y registrado por lo que se deberá tener muy en cuenta qué permitimos y qué no permitimos modificar en fases posteriores a la presentación, aunque FAP tiene la seguridad de ir guardando siempre el historial de lo que se va modificando entre presentación y presentación. Una vez que el solicitante modifique los datos oportunos se deberá volver a presentar la solicitud (en este caso se presentarán las modificaciones de la solicitud), realizando pasos casi homónimos a la presentación normal que conllevan a firmar y registrar la misma.

h2. "Presentación":app-presentacion

El proceso de Presentación, permite realizar todos los pasos que se llevan a cabo para que el solicitante pueda presentar correctamente su solicitud que habrá tenido que rellenar previamente. En esta fase se comprueba que todo lo introducido por parte del solicitante es correcto para la convocatoria del procedimiento en cuestión (tanto los datos como los tipos de documentos que ha subido), se firma con su certificado digital la solicitud y se registra de entrada en la Plataforma de Interoperabilidad del Gobierno de Canarias (Platino), para que surja los efectos correspondientes. Como resultado de que todo ha ido correctamente, se le devolverá un documento en PDF que será el recibo de que ha presentado en plazo y de forma adecuada lo que se le solicitaba para participar en dicha convocatoria.

h2. "Resolución":app-resolucion

El módulo de Resolución de FAP, permite resolver expedientes de la manera que se hace en las administraciones públicas. Por defecto permite diferentes tipos, modalidades, ... además las cuales puedes ser personalizadas completamente en cada aplicación. 
